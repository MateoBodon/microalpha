...
| --- | ---: | --- |
| Market Risk Case, median of 3 clean directories | `22.1551 s` | 2,198-session report, bootstrap inference, SVGs, schemas, hashes |
| Active engine, 100,000 market events | `38,599 events/s` | 10 symbols, target-weight resize, t+1 fills, commission ledger |
