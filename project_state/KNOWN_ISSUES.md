...
- From `PROGRESS.md`: Ticket-01 (2025-12-23) reports now complete; WRDS smoke rerun under ticket-12 integrity checks is complete, but SPA remains degenerate (“all strategies have zero variance”). Full WRDS flagship rerun under the new integrity checks is still pending before performance claims are interpretable.
